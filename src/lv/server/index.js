...
var DOM = {
  ...
  isNewPageHref(href, currentLocation) {
    ...
    try {
      ...
      try {
        url2 = new URL(href, currentLocation);
      } catch (e2) {
        return true;
      }
    }
    if (url2.host === currentLocation.host && url2.protocol === currentLocation.protocol) {
      if (url2.pathname === currentLocation.pathname && url2.search === currentLocation.search) {
        return url2.hash === "" && !url2.href.endsWith("#");
      }
    }
    return true;
  },
...
var liveSocket = new LiveSocket(url, Socket, { params: { _csrf_token: csrfToken }, hooks: {} });
